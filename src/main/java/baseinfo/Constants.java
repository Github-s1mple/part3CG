...
public class Constants {
    // 模型参数
    public static final Double TRUCK_MAX_DISTANCE = 10.0; //千米
    public static final Double TRUCK_COST_PER_METER_PER_TON = 0.0005;
    public static final Integer MAX_VISIT_NUM = 16; //必须设置为偶数
    public static final Double MIN_CARRIER_LOAD = 2.0;
    public static final Double MAX_CAPACITY = 40.0;
    public static final Double BIKE_COST_PER_METER_PER_ORDER = 0.001;
    public static final Double EXPAND_STEP = 0.05; // 标签拓展的步长
    ...
    public static final Integer MAX_RLMP_COLUMNS = 30000;
